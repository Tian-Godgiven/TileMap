...
! function() {
    ...
    const st = I(5, (e => {
        ...
        Dt = e => {
            ...
            return t.isSet("table_default_styles") ? o : ((e, t) => _t(e) || !St(e) ? t : Ot(e) ? {...t, width: mt(e)
            } : {...t, width: it
            })(e, o)
        },
        Nt = e => {
            ...
            return t.isSet("table_default_attributes") ? o : ((e, t) => _t(e) || St(e) ? t : Ot(e) ? {...t, width: mt(e)
            } : {...t, width: it
            })(e, o)
        },
    ...
    var jt = ["body", "p", "div", "article", "aside", "figcaption", "figure", "footer", "header", "nav", "section", "ol", "ul", "li", "table", "thead", "tbody", "tfoot", "caption", "tr", "td", "th", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre", "address"];
    const Ht = (e, t, o, l) => {
            const n = t(e, o);
            return r = (o, l) => {
                const n = t(e, l);
        ...
        Co = e => F(e, (e => ho(e) ? [{...e, menu: Co(e.menu)
        }] : Ie(e.value) ? [e] : [])),
        ...
        Oo = e => Ro.concat((e => yo(Ct(e)).map((e => ({
            name: "class",
            type: "listbox",
            label: "Class",
            items: e
                    ...
                    T(n) > 0 && t.length >= 1 && $e(t[0]).each((o => {
                        ...
                        (a || A(n, "scope")) && ((e, t, o, l) => {
                            ...
                            P(t, (t => {
                                ...
                                })(s, t.column.map((t => Do(e, t))).getOr(s), o, a), gt(e) && ((e, t, o) => {
        ...
        Jo = e => {
            ...
            const o = ((e, t) => {
                    const o = $e(t[0]).map((o => M(Go(o, t), (t => ((e, t, o, l) => {
                        const n = e.dom;
                        return {
        ...
        Xo = e => Qo.concat((e => yo(vt(e)).map((e => ({
            name: "class",
            type: "listbox",
            label: "Class",
            items: e
            ...
            l.close(), e.undoManager.transact((() => {
                ...
                if (T(s) > 0) {
                    ...
                    ((e, t, o, l) => {
                        ...
                        if (a(o.class) || "mce-no-match" === o.class || (r.class = o.class), s.height = fe(o.height), c ? s.width = fe(o.width) : n.getAttrib(t, "width") && (r.width = (e => e ? e.replace(/px$/, "") : "")(o.width)), c ? (m ? (r.border = 0, s["border-width"] = "") : (s["border-width"] = fe(o.border), r.border = 1), s["border-spacing"] = fe(o.cellspacing)) : (r.border = m ? 0 : o.border, r.cellpadding = o.cellpadding, r.cellspacing = o.cellspacing), c && t.children) {
                            const e = {};
                            if (m ? e["border-width"] = "" : l.border && (e["border-width"] = fe(o.border)), l.cellpadding && (e.padding = fe(o.cellpadding)), i && l.bordercolor && (e["border-color"] = o.bordercolor), !(e => {
                                    for (const t in e)
    ...
    e.add("table", (e => {
        ...
        (e => {
            ...
            const o = t => () => e.execCommand(t),
                l = (t, l) => !!e.queryCommandSupported(l.command) && (e.ui.registry.addMenuItem(t, {...l, onAction: c(l.onAction) ? l.onAction : o(l.command)
                }), !0),
                n = (t, l) => {
